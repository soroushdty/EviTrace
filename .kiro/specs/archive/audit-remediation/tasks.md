...
- [x] 1. P0 — Final Output Schema Validation (Req 1)
  - [x] 1.1 Create `configs/final_output_schema.json` and `FinalOutputValidator` class
  ...
  - [x] 1.2 Integrate `FinalOutputValidator` into `_save_pdf_output()` gate
  ...
  - [x] 1.3 Write property tests for schema validation (Properties 1, 2, 3)
  ...
  - [x] 1.4 Write unit tests for `FinalOutputValidator`
...
- [x] 2. P0 — DPI Configuration Propagation (Req 2)
  - [x] 2.1 Wire DPI from config to `extract_with_paddleocr()` in `build_qc_bundle()`
  ...
  - [x] 2.2 Write property test for DPI propagation (Property 4)
  ...
  - [x] 2.3 Write unit test for DPI wiring and deprecation warning
...
- [x] 3. P0 — Per-Page Extraction Routing (Req 3)
  - [x] 3.1 Implement `PageRoutingResult` dataclass and per-page routing logic
  ...
  - [x] 3.2 Write property tests for per-page routing (Properties 5, 6)
...
- [x] 4. P0 — Quality-Based Branch Reconciliation (Req 4)
  - [x] 4.1 Implement `BranchQualityScore` and quality-based primary selection
  ...
  - [x] 4.2 Write property tests for branch reconciliation (Properties 7, 8)
  ...
  - [x] 4.3 Write unit test for branch selection with empty GROBID
...
- [x] 5. P0 — Validation-Aware LLM Retries (Req 5)
  - [x] 5.1 Implement `RepairRetryLoop` class in `pdf_processor.py`
  ...
  - [x] 5.2 Integrate `RepairRetryLoop` into chunk extraction flow
  ...
  - [x] 5.3 Write property tests for repair retry (Properties 9, 10)
  ...
  - [x] 5.4 Write unit tests for repair retry loop
...
- [x] 6. P0 — Content-Hash Evidence Caching (Req 7)
  - [x] 6.1 Replace stat-based `_pdf_hash()` with SHA-256 content hash
  ...
  - [x] 6.2 Write property test for content-hash cache invalidation (Property 12)
  ...
  - [x] 6.3 Write unit test for same-size different-content cache miss
...
- [x] 7. Checkpoint — P0 Milestone
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. P1 — Publication-Year Multi-Source Resolver (Req 8)
  - [x] 8.1 Implement `resolve_publication_year()` function
  ...
  - [x] 8.2 Write property test for year resolution (Property 13)
  ...
  - [x] 8.3 Write unit tests for year resolver
...
- [x] 9. P1 — Normalized Annotation Schema (Req 9)
  - [x] 9.1 Define `NormalizedAnnotation` schema and migrate heuristic annotations
  ...
  - [x] 9.2 Write property test for annotation uniformity (Property 14)
  ...
  - [x] 9.3 Write unit tests for annotation schema
...
- [x] 10. P1 — PyMuPDF Text Spacing Preservation (Req 13)
  - [x] 10.1 Implement gap-aware span joining in `extract_with_pymupdf()`
  ...
  - [x] 10.2 Write property test for span joining (Property 18)
  ...
  - [x] 10.3 Write unit tests for span joining
...
- [x] 11. Checkpoint — P1 Milestone
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. P2 — Safe Logging of Model Responses (Req 6)
  - [x] 12.1 Implement `log_model_response()` utility
  ...
  - [x] 12.2 Integrate safe logging into `pdf_processor.py`
  ...
  - [x] 12.3 Write property test for log truncation (Property 11)
  ...
  - [x] 12.4 Write unit tests for safe logging
...
- [x] 13. P2 — Deterministic Dependency Management (Req 10)
  - [x] 13.1 Remove runtime pip install and add `pyproject.toml` extras
  ...
  - [x] 13.2 Write CI guard test for no runtime pip
...
- [x] 14. P2 — Atomic Output Writes (Req 11)
  - [x] 14.1 Implement `_atomic_write_json()` helper and integrate
  ...
  - [x] 14.2 Write property test for atomic writes (Property 15)
  ...
  - [x] 14.3 Write property test for resume validation (Property 16)
...
- [x] 15. P2 — Manifest Identity and Resumability (Req 12)
  - [x] 15.1 Implement `ManifestIdentity` and staleness detection
  ...
  - [x] 15.2 Write property test for manifest identity (Property 17)
  ...
  - [x] 15.3 Write unit test for manifest identity staleness
...
- [x] 16. P2 — CI Extraction Mode Tests (Req 14)
  - [x] 16.1 Create integration tests for native, OCR, and mixed extraction paths
...
- [x] 17. Final Checkpoint — P2 Milestone
  - Ensure all tests pass, ask the user if questions arise.
