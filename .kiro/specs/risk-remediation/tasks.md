...
- [ ] 2.1 Populate the extractor name on production quality reports and use it as the identity key
...
- [ ] 3.1 Select primary and secondary branches from the adjudication decision with a deterministic fallback
